...
public class EmpresaDTO {
    ...
    public String toString() {
        return "EmpresaDTO{" + "id=" + id + ", nombre=" + nombre + ", direccion=" + direccion + ", latitud=" + latitud + ", longitud=" + longitud + ", num_espacios=" + num_espacios + ", fraccion=" + fraccion + ", precio=" + precio + ", descuento=" + descuento + '}';
    }
